      ...
      integer function extras_check_model(id)
         ...
         if (s%star_age<1d2) then
            ...
            if (abs(s%star_mdot)>1d-20) then
                ...
                !s%high_logT_op_mono_full_off = 9.2d0
                !s%high_logT_op_mono_full_on = 10.0d0
            end if
            !use_op_mono_alt_get_kap = .true.
         else if (s%star_age>1d2) then
            s%Pextra_factor=1
            !s%high_logT_op_mono_full_off = 7.7d0
            !s%high_logT_op_mono_full_on = 7.5d0
            !s%low_logT_op_mono_full_off=-99d0
         end if
